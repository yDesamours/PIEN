...
define(['./workbox-1778e07b'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\.(png|jpg|jpeg|svg|ico|webp|woff|woff2)$/, new workbox.CacheFirst({
